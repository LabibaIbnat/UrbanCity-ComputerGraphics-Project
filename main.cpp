...
void myDisplay(void)
{
    ...
    if(!cover)
    {
        ...
        renderBitmapString(-0.3f, 0.85f, 0.0f, GLUT_BITMAP_HELVETICA_18, " 01123 - COMPUTER GRAPHICS [H]");

        glPushMatrix();

        renderBitmapString(-0.24f, 0.75f, 0.0f, GLUT_BITMAP_HELVETICA_18, "URBAN MAJESTIC CITY");
        glLoadIdentity();
        glPopMatrix();

        renderBitmapString(-0.28f, 0.65f, 0.0f, GLUT_BITMAP_HELVETICA_18, "Submitted by: ");
        renderBitmapString(-0.5f, 0.5f, 0.0f, GLUT_BITMAP_HELVETICA_18, "          ID                          NAME ");
        renderBitmapString(-0.5f, 0.4f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    20-44229-3      RUBYEA ZANNAT");
        renderBitmapString(-0.5f, 0.3f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    20-44252-3      MD. TANZIM BIN IDRIS ");
        renderBitmapString(-0.5f, 0.2f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    20-44256-3      KHALED HOSSAIN ");
        renderBitmapString(-0.5f, 0.1f, 0.0f, GLUT_BITMAP_HELVETICA_18, "    20-44338-3      SAMIHA LABIBA IBNAT ");

        renderBitmapString(-0.5f, -0.1f, 0.0f, GLUT_BITMAP_HELVETICA_18, "      Press F to uncover the Project ");

        renderBitmapString(-0.11f, -0.5f, 0.0f, GLUT_BITMAP_HELVETICA_18, "Submitted to: ");
        renderBitmapString(-0.18f, -0.6f, 0.0f, GLUT_BITMAP_HELVETICA_18, "MD. SIYAMUL ISLAM ");
